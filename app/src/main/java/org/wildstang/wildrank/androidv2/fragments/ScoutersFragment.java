...
public class ScoutersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        list.setAdapter(new ArrayAdapter<MatchModel>(getActivity(), R.layout.list_item_scouters, R.id.red1, matchList) {
        ...
        scouters.setAdapter(new ArrayAdapter<Scouter>(getActivity(), R.layout.list_item_scouter, R.id.scouterName, scoutCounter) {
            public View getView(int position, View convertView, ViewGroup parent) {
                View view;
                if (convertView == null) {
                    LayoutInflater inflater = (LayoutInflater) getActivity().getSystemService(getActivity().LAYOUT_INFLATER_SERVICE);
