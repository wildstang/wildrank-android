...
public class SerializableSpinnerView extends ScoutingView implements OnItemSelectedListener, OnClickListener {
	...
	public SerializableSpinnerView(Context context, AttributeSet attrs) {
		super(context, attrs);
		...
		a.recycle();
		a = context.obtainStyledAttributes(attrs, R.styleable.SerializableSpinnerView, 0, 0);
		int spinnerValuesId = a.getResourceId(R.styleable.SerializableSpinnerView_values, 0);
		...
		editable = a.getBoolean(R.styleable.SerializableSpinnerView_editable, false);
		defaultValue = a.getString(R.styleable.SerializableSpinnerView_defaultValue);
		a.recycle();
